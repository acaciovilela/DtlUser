...
class AuthController extends AbstractActionController {
    ...
    /**
     * Auth manager.
     * @var DtlUser\Service\AuthManager 
     */
    private $authManager;
    ...
    /**
     * User manager.
     * @var DtlUser\Service\UserManager
     */
    private $userManager;
    ...
    public function loginAction() {
        ...
        if (strlen($redirectUrl) > 2048) {
            throw new \Exception("Url de redirecionamento muito longa.");
        }
                ...
                if ($result->getCode() == Result::SUCCESS) {
                    ...
                    if (!empty($redirectUrl)) {
                        ...
                        if (!$uri->isValid() || $uri->getHost() != null) {
                            throw new \Exception('URL incorreta: ' . $redirectUrl);
                        }
                    }
    ...
    public function onDispatch(\Laminas\Mvc\MvcEvent $e) {
        ...
        $this->layout()->setTemplate('layout/authentication');
        return $response;
    }
